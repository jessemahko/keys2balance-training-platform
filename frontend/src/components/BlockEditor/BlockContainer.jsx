...
const BlockContainer = ({ 
  ...
  return (
    <div className="relative mb-6 group">
      <div 
        className="relative bg-white rounded-2xl p-8 shadow-sm border border-border-color transition-all duration-200 hover:border-primary-light hover:shadow-[0_14px_25px_rgba(81,69,135,0.15)] hover:scale-[1.01]"
      >
